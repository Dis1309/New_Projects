...
exports.asymmetricDecryptFromEncoding = exports.asymmetricEncryptToEncoding = exports.sign = exports.asymmetricDecrypt = exports.asymmetricEncrypt = exports.derive = exports.compressPublicKey = exports.removePublicKeyPrefix = exports.getPublicCompressed = exports.getPublicKey64 = exports.getPublicKey = exports.generateKeyPair = exports.generatePrivateKey = exports.recoverPublicKey = void 0;
 ...
 */
function getPublicKey64(privateKey) {
    return secp256k1_1.default.publicKeyCreate(privateKey, false).slice(1);
}
exports.getPublicKey64 = getPublicKey64;
/**
 * Generate 65-byte uncompressed public key from private key
 *
 * @returns 65 byte public key
 ...
 * @returns 64 byte public key
 */
function removePublicKeyPrefix(publicKey) {
    if (publicKey.byteLength === 65)
        return publicKey.slice(1);
    return publicKey;
}
exports.removePublicKeyPrefix = removePublicKeyPrefix;
/**
