        ...
        <div className="authenticationPageReal">
            ...
            <div className="apr-content">
                ...
                <div className="sub-text">
                    We’ve sent a confirmation code to <span className="hardcode">------</span>
                </div>
                
            </div>
            <div className="apr-input">
                <div className="text">Confirmation code</div>
