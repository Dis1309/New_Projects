...
export default function ConfirmationPageReal1() {
    return (
        <div className="confirmationPageReal1">
            ...
            <div className="cpr1-input">
                ...
                <div className="cpr1-btn-text">
                    Don’t have a web3 wallet?
                </div>
                <div className="cpr1-btn">
                    <button className="btn-1">Create Your Wallet with a Single Click</button>
                </div>
            </div>
